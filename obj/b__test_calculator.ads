...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_calculator" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#43280228#;
   ...
   u00082 : constant Version_32 := 16#57303626#;
   pragma Export (C, u00082, "calculatorB");
   u00083 : constant Version_32 := 16#eb5e8241#;
   pragma Export (C, u00083, "calculatorS");
   u00084 : constant Version_32 := 16#dde34de3#;
   pragma Export (C, u00084, "system__exp_intB");
   u00085 : constant Version_32 := 16#11785907#;
   pragma Export (C, u00085, "system__exp_intS");
